...
/**
 * Represents a configurable setting option with a defined control type.
 * @param <T> The type of the value this setting controls.
 */
public final class SettingsOption<T> {
    ...
    /** Creates a toggle option with enabled state and indentation. */
    ...
    /** Creates a choice option with enabled state and indentation. */
    public static <T> SettingsOption<T> choice(
            String id,
            String nameKey,
            String tooltipKey,
    ...
    /** Creates an action button option. */
    ...
    /** Creates an action button option with enabled state. */
